...
namespace JayTom.Dws.Client.Service.ProcessingServices
{
    ...
    public class ZhuoYanScmBackgroundService : Microsoft.Extensions.Hosting.BackgroundService
    {
        ...
        public ZhuoYanScmBackgroundService(IPackageSessionStore packageSessionStore,
        ...
        protected override async Task ExecuteAsync(CancellationToken stoppingToken)
        {
            try
            {
                ...
                _volumeSettingsDto = await _settingsStore.GetAsync<VolumeSettingsDto>("VolumeSettings", stoppingToken) ?? new VolumeSettingsDto();
            }
            catch (Exception e)
            {
