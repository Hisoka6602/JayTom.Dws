...
namespace JayTom.Dws.Client.ViewModels.Pages.Preferences.LogsViewModel
{
    ...
    {
        private readonly ILogQueryService<FtpLogInfoModel> _logQueryService;
        ...
        public FtpLogPageViewModel(ILogQueryService<FtpLogInfoModel> logQueryService)
        {
            ...
            await UiThread.Dispatcher.InvokeAsyncUnwrapped(async () =>
            {
                ...
                if (loadingDialog.DataContext is LoadingDialogViewModel model)
                {
                    ...
                    if (result.Total > 0)
                    {
                        ...
                        {
                            var cameraLogItemModels = result.Items.Select(s => new FtpLogItemModel()
                            {
