...
namespace JayTom.Dws.CloudApiDbTest.Migrations
{
    ...
    [Migration("20241005102457_AddDisplayIdentifierColumn")]
    partial class AddDisplayIdentifierColumn
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JayTom.Dws.Data.CloudApiData.ExceptionMatchInfoModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("CustomRegex")
                        ...
                        .HasColumnName("CustomRegex");

                    b.Property<int>("DataSource")
                        .HasColumnType("int")
                        .HasColumnName("DataSource");

                    b.Property<long>("ExceptionTypeId")
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Conf_ExceptionMatchInfo", "dbo");
                });

            modelBuilder.Entity("JayTom.Dws.Data.CloudApiData.ExceptionTypeInfoModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<string>("ExceptionColor")
                        .IsRequired()
                        .HasColumnType("longtext")
                        .HasColumnName("ExceptionColor");
                    ...
                    b.ToTable("Conf_ExceptionTypeInfo", "dbo");
                });
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.NvrInfoModel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.SortingInfoModel", b =>
                {
                    ...
                    b.Property<int>("AbnormalSortingType")
                        .HasColumnType("int")
                        .HasColumnName("AbnormalSortingType");
            ...
            modelBuilder.Entity("JayTom.Dws.Data.CloudApiData.ExceptionMatchInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.CloudApiData.ExceptionTypeInfoModel", "ExceptionInfo")
                        .WithMany("ExceptionMatchInfos")
            ...
            modelBuilder.Entity("JayTom.Dws.Data.CloudApiData.ExceptionTypeInfoModel", b =>
                {
                    b.Navigation("ExceptionMatchInfos");
                });
