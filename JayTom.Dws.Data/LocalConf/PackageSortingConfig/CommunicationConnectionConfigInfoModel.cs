...
namespace JayTom.Dws.Data.LocalConf.PackageSortingConfig {
    ...
    public class CommunicationConnectionConfigInfoModel : BasePackageSortingConfig {
        ...
        /// 连接名称
        /// </summary>
        [Column("ConnectionName"), InsertOrUpdata]
        ...
        /// 通讯类型
        /// </summary>
        [Column("CommunicationType"), InsertOrUpdata]
        ...
        /// 通讯协议
        /// </summary>
        [Column("CommunicationProtocol"), InsertOrUpdata]
        ...
        /// 重连最大重试次数
        /// </summary>
        [Column("MaxReconnectAttempts"), InsertOrUpdata]
