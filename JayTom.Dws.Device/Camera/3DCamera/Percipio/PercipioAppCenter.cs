...
namespace JayTom.Dws.Device.Camera._3DCamera.Percipio {
    ...
    public class PercipioAppCenter : PercipioAppInterfacesBase {
        ...
        public static extern int TYAppSetDataCallback(TYAppDataCallBack callback, IntPtr user_data);
        ...
        public static extern int TYAppSetEventCallback(TYAppEventCallBack callback, IntPtr user_data);
