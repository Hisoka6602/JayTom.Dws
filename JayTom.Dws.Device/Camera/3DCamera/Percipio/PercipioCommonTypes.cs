...
namespace JayTom.Dws.Device.Camera._3DCamera.Percipio {
    ...
    public class PercipioCommonTypes {
        ...
        [StructLayout(LayoutKind.Sequential, Pack = 1)]
        public struct XData {
            public Byte action_type; ///< request or response, see I_ACTION_TYPE_LIST
            public Byte action_id; ///< action id, see I_ACTION_ID_LIST
            public Int16 error_id;  ///< will be ignored in request and valid in response
            public Int32 target_id; ///< property id or cmd id
            public Int32 uid;       ///< UID for user to match request and answer
            public UInt32 length;    ///< data length in bytes
        };
