...
namespace JayTom.Dws.Domain.Dto.CloudApiDto {
    ...
    public class PackageDto {
        ...
        /// 上传信息
        /// </summary>
        public UploadInfoDto? UploadInfo { get; set; }

        /// <summary>
        /// 格口信息
        /// </summary>
        public ExitInfoDto? ExitInfo { get; set; }

        /// <summary>
        /// 分拣信息
        /// </summary>
        public SortingInfoDto? SortingInfo { get; set; }
        ...
        /// Ocr信息
        /// </summary>
        public OcrInfoDto? OcrInfo { get; set; }
    ...
    public class OcrInfoDto {
        ...
        /// Ocr详细信息
        /// </summary>
        public List<OcrDetailedInfoDto>? OcrDetailedInfos { get; set; }
    }
    ...
    /// Ocr详细信息
    /// </summary>
    public class OcrDetailedInfoDto {
