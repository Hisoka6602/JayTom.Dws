...
namespace JayTom.Dws.Infrastructure.Repository.LocalConf.PackageSortingConfig.ConnectionParams {
    ...
    public class HeartbeatConfigRepository : LocalRepositoryBase<HeartbeatConfigInfoModel, SqliteConfContext>, IHeartbeatConfigRepository {

        public HeartbeatConfigRepository(IDbContextFactory<SqliteConfContext> contextFactory, IMemoryCache cache) : base(contextFactory, cache) {
        }
    }
}