...
namespace JayTom.Dws.Infrastructure.Repository.LocalLog {
    ...
    public class CameraLogRepository : LocalRepositoryBase<CameraLogInfoModel, SqliteLogsContext>, ICameraLogRepository {
        ...
        public async Task<KeyValuePair<bool, string>> DeleteDataThanDays(int days) {
            try {
                ...
                var dbSet = concardContext?.Set<CameraLogInfoModel>();
