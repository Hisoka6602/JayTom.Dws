...
namespace JayTom.Dws.Infrastructure.Repository.LocalLog {
    ...
    public class InputLogRepository : LocalRepositoryBase<InputLogInfoModel, SqliteLogsContext>, IInputLogRepository {
        ...
        public async Task<KeyValuePair<bool, string>> DeleteDataThanDays(int days) {
            try {
                ...
                var dbSet = concardContext?.Set<InputLogInfoModel>();
