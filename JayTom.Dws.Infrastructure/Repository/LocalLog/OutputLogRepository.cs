...
namespace JayTom.Dws.Infrastructure.Repository.LocalLog {
    ...
    public class OutputLogRepository : LocalRepositoryBase<OutputLogInfoModel, SqliteLogsContext>, IOutputLogRepository {
        ...
        public async Task<KeyValuePair<bool, string>> DeleteDataThanDays(int days) {
            try {
                ...
                var dbSet = concardContext?.Set<OutputLogInfoModel>();
