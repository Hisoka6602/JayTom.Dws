...
namespace JayTom.Dws.Infrastructure.Repository.LocalLog {
    ...
    public class SortingLogRepository : LocalRepositoryBase<SortingLogInfoModel, SqliteLogsContext>, ISortingLogRepository {
        ...
        public async Task<KeyValuePair<bool, string>> DeleteDataThanDays(int days) {
            try {
                ...
                var dbSet = concardContext?.Set<SortingLogInfoModel>();
