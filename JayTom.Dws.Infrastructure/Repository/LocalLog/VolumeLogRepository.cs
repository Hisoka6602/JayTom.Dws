...
namespace JayTom.Dws.Infrastructure.Repository.LocalLog {
    ...
    public class VolumeLogRepository : LocalRepositoryBase<VolumeLogInfoModel, SqliteLogsContext>, IVolumeLogRepository {
        ...
        public async Task<KeyValuePair<bool, string>> DeleteDataThanDays(int days) {
            try {
                ...
                var dbSet = concardContext?.Set<VolumeLogInfoModel>();
