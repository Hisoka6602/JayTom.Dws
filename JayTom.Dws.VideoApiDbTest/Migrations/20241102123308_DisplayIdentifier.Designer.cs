...
namespace JayTom.Dws.VideoApiDbTest.Migrations
{
    ...
    [Migration("20241102123308_DisplayIdentifier")]
    partial class DisplayIdentifier
    {
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.AggregatePackagesInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        ...
                        .HasForeignKey("JayTom.Dws.Data.Package.AggregatePackagesInfoModel", "Id")
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.ExitInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("ExitInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.ExitInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.LogisticsInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        ...
                        .HasForeignKey("JayTom.Dws.Data.Package.LogisticsInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.OcrInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("OcrInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.OcrInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.SortingInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("SortingInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.SortingInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.UploadInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("UploadInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.UploadInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.VolumeInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("VolumeInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.VolumeInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JayTom.Dws.Data.Package.WeightInfoModel", b =>
                {
                    b.HasOne("JayTom.Dws.Data.Package.PackageInfoModel", "PackageInfo")
                        .WithOne("WeightInfo")
                        .HasForeignKey("JayTom.Dws.Data.Package.WeightInfoModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
